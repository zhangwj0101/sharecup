...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="">参赛指南</a>&gt;&gt;<a href="">评审、公示及颁奖</a></p>
                
                
                <h2 class="h_title">评审、公示及颁奖</h2>
                ...
                <div class="p_cont">
					...
					<p class="p1">评审、公示及颁奖</p>
					<p class="p2">　　　1、评审：为了保证公平、公正、公开、原创的原则，2015年11月对提交的作品进行评审，12月将在官方网站公布获奖作品名单，公示期限为10天。</p>
					<p class="p2">　　　在公示期间，公众可对入选作品进行监督，并可投诉举报违规作品，竞赛组委会根据举报内容予以调查核实，违规作品将被取消候选资格。</p>
					<p class="p2">　　　2、颁奖：2015年12月在北京举行颁奖仪式。</p>
