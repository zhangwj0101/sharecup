...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="">参赛指南</a>&gt;&gt;<a href="">时间节点</a></p>
                
                
                <h2 class="h_title">时间节点</h2>
                ...
                <div class="p_cont">
					...
					<p class="p1">作品提交方式及时间</p>
					<p class="p2">　　　1、提交方式：个人、团队作品通过大学生竞赛活动的官网进行提交。</p>
					<p class="p2">　　　2、截止时间：2015年10月31日。</p>
