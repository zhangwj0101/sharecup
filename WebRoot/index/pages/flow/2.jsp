...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="">参赛指南</a>&gt;&gt;<a href="">参赛条件</a></p>
                
                
                <h2 class="h_title">参赛条件</h2>
                ...
                <div class="p_cont">
					...
					<p class="p1">参赛条件</p>
					<p class="p2">　　　高等院校和研究院所的在读本科生、硕士研究生、博士研究生都可以以个人或团队形式（队员数量不得超过5人）参加竞赛。</p>
					<p class="p2">　　　参赛团队或个人可根据需要，邀请1-2名指导教师给予指导帮助。</p>
