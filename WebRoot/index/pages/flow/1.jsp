...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="">参赛指南</a>&gt;&gt;<a href="">参赛流程</a></p>
                
                
                <h2 class="h_title">参赛流程</h2>
                ...
                <div class="p_cont">
					...
					<p class="p1">报名参赛</p>
					<p class="p2">1、团队及个人自由参赛。团队及个人通过大赛官网报名参赛（网址：share.escience.gov.cn），获得参赛账号密码。</p>
					<p class="p2">2、单位组织报名。参赛高校和研究院所组织本单位学生参赛，收集参赛学生姓名、参赛题目等信息，通过大赛官网提交，由大赛承办单位进行资格确认后，统一分配账号密码。</p>
					<p class="p2" style="text-align:center;"><img src="<%=basePath %>img/lct1_01.jpg"/></p>
