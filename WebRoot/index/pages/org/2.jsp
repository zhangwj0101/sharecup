...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="">组织委员会</a></p>
                
                
                <h2 class="h_title">组织委员会</h2>
                ...
                <div class="p_cont">
					...
					<p class="p1">主任</p>
					<p class="p2">国家科技基础条件平台中心主任              戴国强</p>


					<p class="p1">副主任</p>
					<p class="p2">国家科技基础条件平台中心副主任            吕先志</p>
					<p class="p2">国家科技基础条件平台中心副主任            苏  靖</p>
					<p class="p2">国家科技资源共享服务工程技术研究中心主任  吕卫锋</p>


					<p class="p1">委员</p>
					<p class="p2">袁  伟、王瑞丹、张  辉、卢  凡、华  夏、黄珍东、陈志辉、罗  亮、肖惠萍、张广忠、孙兴莲、郭  爱</p>
