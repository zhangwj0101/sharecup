...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="">组委会秘书处</a></p>
                
                
                <h2 class="h_title">组委会秘书处</h2>
                ...
                <div class="p_cont">
					...
					<p class="p1">秘书长</p>
					<p class="p2">国家科技基础条件平台中心处长               袁  伟</p>

					<p class="p1">副秘书长</p>
					<p class="p2">国家科技基础条件平台信息技术中心副主任     张  辉</p>

					<p class="p1">综合组</p>
					<p class="p2">石  蕾、王  正、周净泓、刘  伟</p>
					
					<p class="p1">资源组</p>
					<p class="p2">刘  瑞、王  祎、刘远君、李  健</p>
					
					<p class="p1">技术组</p>
					<p class="p2">王德庆、蒙长江、彭恩静、卢正孜</p>										

					<p class="p1">宣传组</p>
					<p class="p2">梁奎阳、魏玺湾、刘  召、李  伟</p>	
					</div>
