...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="">专家委员会</a></p>
                
                
                <h2 class="h_title">专家委员会</h2>
                ...
                <div class="p_cont">
					...
					<p class="p1">主  席</p>
					<p class="p2">刘德培    院  士</p>

					<p class="p1">副主席</p>
					<p class="p2">孙九林    院  士</p>
					<p class="p2">李  未    院  士</p>
					<p class="p2">刘  旭    院  士</p>
					<p class="p2">尹伟伦    院  士</p>
					<p class="p2">何鸣鸿    研究员</p>
					
					<p class="p1">委员（按姓氏笔画排序）</p>
					<p class="p2">丁  辉、于贵瑞、马月辉、马克平、尹  岭、王  臣、邓  帆、任贺春、刘玉琴、刘敦一、刘  晴、纪  平、许  可、李红梅、李晓刚、汪  滨、周国民、郑勇奇、姜瑞波、胡铁军、唐五湘、徐  坚、诸云强、高  蔚、曹永生、阎保平、李一凡、王新宴</p>
					</div>
