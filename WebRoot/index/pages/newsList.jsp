...
<div id="flashbox">	
	<div id="side_r1">
	<div class="gxbox">	
	<div class="gx_bt"><span class="gx_bt_txt">最新动态</span></div>
	<div class="show">	
	<ul>
		<s:iterator  value="%{#request.newsList}" id="news" status="i">
		 	<li class="show_lb"><a class="show_lbb" style="float:left;" href="<%=basePath %>index/pageIndex_newsContent.action?id=${news.id}">${news.title}</a><a style="float:right;margin-right: 100px;">${news.times}</a></li>
		</s:iterator>
  	</ul>
  	</div>
  ...
  <form id="pageForm" action="pageIndex_newsList" method="post">
