...
<html>
	...
	<head>
		<title> 国家计量基标准（物理部分）资源共享基地: 特定计量基标准服务社会宣传动漫（以民生为主方向） </title>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
                ...
                <h2 class="h_title"> 气象科学数据资源应用</h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						　　<p>&nbsp;&nbsp;&nbsp;&nbsp;<b>要求：</b>可选题目包括《全球气候变暖在中国的响应》、《我看极端天气气候事件》、《用数据验证气象谚语的科学性》。要求运用中国历史气象观测数据，围绕论题</p>
						
						<p>进行研究分析，要求方法科学合理、论据充分，并提出观点、结论。 </p>
						<p>&nbsp;&nbsp;&nbsp;&nbsp;<b>数据：</b>
					      <p>&nbsp;&nbsp;&nbsp;&nbsp;1. 中国地面国际交换站气候资料月值数据集（文件名：中国地面国际交换站气候资料月值数据集（1951-1970）.csv, 中国地面国际交换站气候资料月值数据集（1970-1990）.csv,
					      <p>&nbsp;&nbsp;&nbsp;&nbsp; 中国地面国际交换站气候资料月值数据集（1990-2013）.csv）</p>
			...
			<div class="content" style="display:none;">
				...
				<div class="left">
					...
					<div class="m-detail">
						...
						<div class="m-title"> <h3> 国家计量基标准（物理部分）资源共享基地: 特定计量基标准服务社会宣传动漫（以民生为主方向） </h3></div>
						
						<div class="m-content">
						　　<p>&nbsp;&nbsp;&nbsp;&nbsp;<b>要求：</b>根据相关介绍性材料及图片素材，采用动漫的手法，按各自不同的主题，设计和制作动画、动漫作品进行评比。
							       具体要求请参见考核要求及打分标准。编写所用的程序语言不作限制。</p>
                           <p>&nbsp;&nbsp;&nbsp;&nbsp;<b> 数据：</b>
                           	
                               <p>1. 计量基准（文件名：计量基准.xls）</p>
                           	   <p>2. 计量标准（文件名：计量标准.xls）</p>
                               <p>3. 运行服务案例 （见运行服务平台填报案例）</p>
