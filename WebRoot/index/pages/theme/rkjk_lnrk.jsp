...
<html>
	...
	<head>
		<title>人口与健康学科学数据共享平台: 老年人口健康状况调查数据主要评估指标的可视化展示</title>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title">老年人口健康状况调查数据主要评估指标的可视化展示</span></a></p>
                
                
                <h2 class="h_title">老年人口健康状况调查数据主要评估指标的可视化展示</h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						　　<p>&nbsp;&nbsp;&nbsp;&nbsp;<b>要求：</b>
							      开发语言、平台、软件工具不限，要求可视化结果直观明了、展现形式多样。
                           ...
                           <p>&nbsp;&nbsp;&nbsp;&nbsp;<b>数据：</b>
                   	      <p>&nbsp;&nbsp;&nbsp;&nbsp;
                           	...
                           	<p>&nbsp;&nbsp;&nbsp;&nbsp;<b>考核要求：</b>
				          <p>&nbsp;&nbsp;&nbsp;&nbsp;1.利用目前主流开发语言（Java、C#）；[20分]</p>
							   <p>&nbsp;&nbsp;&nbsp;&nbsp;2.数据库采用Oracle或SQL Server；[20分]</p>
							   <p>&nbsp;&nbsp;&nbsp;&nbsp;3.功能实现：可查询3个以上单指标（一个指标10分，共30分）多指标查询，一次查询2个指标以上[30分]</p>
