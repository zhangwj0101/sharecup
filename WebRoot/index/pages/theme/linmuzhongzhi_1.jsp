...
<html>
	...
	<head>
		<title> 国家林木种质资源平台: 树木电子词典开发 </title>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href="">树木电子词典开发</a></p>
                
                
                <h2 class="h_title">树木电子词典开发 </h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						　　<p>&nbsp;&nbsp;&nbsp;&nbsp;<b>要求：</b>
							  利用平台树种库，制作一个网络版的中、英、拉丁文电子词典。要求用户可以修改词条和添加新词，并须经管理员确认，不断丰富词典的内容；通过树种检索能够关联网络中关于该树种的信息、图片等。产品形式：电子词典软件+网页
							  </p>
                           <p>&nbsp;&nbsp;&nbsp;&nbsp;<b>数据：</b>
                           	  1. 林木树种名录（文件名：treelist.xls）
                           	
                       	  </p>
                           <p>&nbsp;&nbsp;&nbsp;&nbsp;<b>考核要求：</b>
						      <p>&nbsp;&nbsp;&nbsp;&nbsp;1.	关联中文名、英文名、拉丁名，实现三者的互查；</p>
							   <p>&nbsp;&nbsp;&nbsp;&nbsp;2.分析树种代码，分析科、属、种间的关系，查询结果显示树种的分类地位，显示关联的种属；</p>
							    <p>&nbsp;&nbsp;&nbsp;&nbsp;3.智能搜索，录入1个字母或汉字根据查询频次显示常用的查询，如输入“杉”字自动显示最常用的“杉木”供选择，提高查询速度和效率。</p>
								 <p>&nbsp;&nbsp;&nbsp;&nbsp;4.添加和修改词条，要求用户可以修改词条和添加新词，并须经管理员确认，不断丰富词典的内容；</p>
								  <p>&nbsp;&nbsp;&nbsp;&nbsp;5.网络资源关联，通过树种检索能够关联网络中关于该树种的信息、图片等。</p>
