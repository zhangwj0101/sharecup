...
<html>
	...
	<head>
		<title> 中国数字科技馆:中国数字科技馆科普资源的分类和管理研究 </title>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title">中国数字科技馆科普资源的分类和管理研究</span></a></p>
                
                
                <h2 class="h_title">中国数字科技馆科普资源的分类和管理研究</h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						　　<p>&nbsp;&nbsp;&nbsp;&nbsp;<b>要求：</b>针对中国数字科技馆内的科普内容，研究数字化科普资源的分类、管理、复用及呈现。提高资源管理效率，提升资源传播效果</p>
                           <p>&nbsp;&nbsp;&nbsp;&nbsp;<b> 数据： </b> 中国数字科技馆所有内容，网址：<a href="http://www.cdstm.cn" target="_blank">www.cdstm.cn</a>(咨询电话：59041558，邮箱：spring7214@126.com)</p>
                           <p>&nbsp;&nbsp;&nbsp;&nbsp;<b>考核要求：</b>
						   <p>&nbsp;&nbsp;&nbsp;&nbsp;1．梳理中国数字科技馆现有数字化科普资源内容。（25分）</p>
						   <p>&nbsp;&nbsp;&nbsp;&nbsp;2．从不同维度提出切实可行的数字化科普资源的分类标准。（25分）</p>
						   <p>&nbsp;&nbsp;&nbsp;&nbsp;3．基于数字化科普资源的分类，提出数字科技馆内容的管理模式，达到提高资源管理效率的目的。（25分）</p>
						   <p>&nbsp;&nbsp;&nbsp;&nbsp;4．对中国数字科技馆内容的呈现和复用进行研究，提升科普内容的传播效果。（25分）</p>
