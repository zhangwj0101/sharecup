...
<html>
	...
	<head>
		<title> 人口与健康学科学数据共享平台: 基于气象数据的上呼吸道感染逐日发病人数的预测</title>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title">基于气象数据的上呼吸道感染逐日发病人数的预测</span></a></p>
                
                
                <h2 class="h_title">基于气象数据的上呼吸道感染逐日发病人数的预测</h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						　　<p>&nbsp;&nbsp;&nbsp;&nbsp;<b>要求：</b>
							      <p>&nbsp;&nbsp;&nbsp;&nbsp;利用上呼吸道疾病及其同期的气象数据，对上呼吸道感染发病率与气象因子的关系进行探讨, 采取科学合理的方法，对上呼吸道感染逐日发病人数进行预测。</p>
