...
<html>
	...
	<head>
		<title> 中国应急分析测试平台数据库核心元数据导出工具 </title>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href="">中国应急分析测试平台数据库核心元数据导出工具</a></p>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						　　<p>&nbsp;&nbsp;&nbsp;&nbsp;<b>要求：</b>    </p>
							<p>&nbsp;&nbsp;&nbsp;&nbsp;1．设计一款Windows平台应用软件，用于从中国应急分析测试平台网站数据库中导出核心元数据，并生成符合国家科技基础条件平台核心元数据规范的XML文档。</p>
