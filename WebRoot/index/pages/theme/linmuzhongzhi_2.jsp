...
<html>
	...
	<head>
		<title> 国家林木种质资源平台: 林木种质资源快速检索工具</title>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title">林木种质资源快速检索工具</span></a></p>
                
                
                <h2 class="h_title">林木种质资源快速检索工具</h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						　　<p>&nbsp;&nbsp;&nbsp;&nbsp;<b> 要求：</b>
							分析种质资源的多样性与复杂性，来设计一个可以通过从物种形态，资源收集地，收集单位等多入口检索系统。
							最终达到让想了解某种质资源的用户，
							根据自己对该种质的了解程度或需求，通过软件很快的获得最大的信息量。
							
							</p>
                           <p>&nbsp;&nbsp;&nbsp;&nbsp;<b>数据：</b>
                       	  <p>&nbsp;&nbsp;&nbsp;&nbsp;1. 杉木种质资源数据1402条记录</p>
                           	  <p>&nbsp;&nbsp;&nbsp;&nbsp;2.马尾松种质资源1516条记录</p>
                           	  <p>&nbsp;&nbsp;&nbsp;&nbsp;3.林科院热林中心(大青山库)种质资源数据1213条记录</p>
                           	
                           	<p>&nbsp;&nbsp;&nbsp;&nbsp;<b>考核要求：</b>
						   <p>&nbsp;&nbsp;&nbsp;&nbsp;1.分析林木种质资源数据的结构关系，实现科、属、种的分类检索；</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;2.分析树种来源，实现按种质资源所在地区检索；</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;3.分析物种与种质形态特征描述方法，建立按形态检索方法，一步一步缩小检索范围；</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;4.将几种检索方法结合，实现快速、精确检索</p>
