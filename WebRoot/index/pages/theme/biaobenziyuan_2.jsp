...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title">数字志书终端浏览程序 </span></a></p>
                
                
                <h2 class="h_title"> 数字志书终端浏览程序 </h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						  <p>&nbsp;&nbsp;&nbsp;&nbsp;<b>要求：</b>开发国家标本资源共享平台终端电子书程序。具体设计方案和测试数据见附件2和附件3。</p>
						  <p>要求参赛者能实现附件2设计方案中的程序界面和功能，能仿照附件3中的数据格式，利用国家标本资源共享平台的物种名称、标本和文献数据整理制作一本简单的电子书。 </p>
						  <p>&nbsp;&nbsp;&nbsp;&nbsp;<b>数据：</b>1.国家标本资源共享平台（http://www.nsii.org.cn/）
                           	和子平台（子平台连接在http://www.nsii.org.cn/）、
                           	自然标本馆（http://www.nature-museum.net）网站上的相关内容。</p>
                           <p>&nbsp;&nbsp;&nbsp;&nbsp;
						       <b>考核要求及分值</b>
					      <p>&nbsp;&nbsp;&nbsp;&nbsp;1．实现程序页面框架设计。满分10分。</p>
							   <p>&nbsp;&nbsp;&nbsp;&nbsp;2．实现目录及其向正文跳转的功能。满分20分。</p>
							   <p>&nbsp;&nbsp;&nbsp;&nbsp;3．实现正文中植物检索表功能。满分20分。</p>
							   <p>&nbsp;&nbsp;&nbsp;&nbsp;4．实现正文页面相互链接跳转功能。满分20分。</p>
							   <p>&nbsp;&nbsp;&nbsp;&nbsp;5. 实现索引功能。满分10分</p>
							   <p>&nbsp;&nbsp;&nbsp;&nbsp;6. 实现搜索功能。满分20分。</p>
