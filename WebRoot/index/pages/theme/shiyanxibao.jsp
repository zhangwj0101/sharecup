...
<html>
	...
	<head>
		<title>  国家实验细胞资源共享平台: 人源细胞STR比对评价软件开发 </title>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title">人源细胞STR比对评价软件开发 </span></a></p>
                
                
                <h2 class="h_title">人源细胞STR比对评价软件开发 </h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						  <p>&nbsp;&nbsp;&nbsp;&nbsp; <b>要求：</b>
					      <P>&nbsp;&nbsp;&nbsp;&nbsp;人来源细胞资源，质量检测的金标准是STR（段重复序列）检测分析。国家实验细胞资源共享平台的细胞资源，已开展了STR检测，相应数据已建库。现重要期刊发表论文时所使用细胞均需提供STR检测情况说明。为方便用户使用平台数据，作为参照标准，需提供相应软件，便于比对。</P>
							...
							<p>&nbsp;&nbsp;&nbsp;&nbsp;<b> 数据：</b>
                       	  ...
                       	  <P>&nbsp;&nbsp;&nbsp;&nbsp;1.ATCC的部分细胞STR结果，excel格式</P>
                           	<p>&nbsp;&nbsp;&nbsp;&nbsp;2.国家实验细胞资源共享平台的部分细胞STR结果。</p>
                           	...
                           	<p>&nbsp;&nbsp;&nbsp;&nbsp;<b>考核要求：</b>
				          <p>&nbsp;&nbsp;&nbsp;&nbsp;1. 利用已有数据库，补充完善更新数据，建立STR标准数据库。与excel兼容，可扩充。</p>
						        <p>&nbsp;&nbsp;&nbsp;&nbsp;2.编写软件，在平台网站呈现界面，提供比对及评价服务</p>
						       <p>&nbsp;&nbsp;&nbsp;&nbsp;3.评价标准，75%以上相同，即可认为是同一个来源是细胞。</p>
