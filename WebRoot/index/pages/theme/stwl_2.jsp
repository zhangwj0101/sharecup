...
<html>
	...
	<head>
		<title> 国家生态系统观测研究网络:  CERN森林生态系统生物多样性评估</title>
            ...
            <div class="right">
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						　　<p>&nbsp;&nbsp;&nbsp;&nbsp;<b>要求：</b>
							根据森林生态系统生物观测的每木调查，乔木、灌木、草本的物种组成等数据，采用群落生态学研究方法，分析不同区域森林生态系统群落组成特征、乔木、灌木、草本物种数量特征、物种多样性以及一定时间尺度上群落组成变化、演替情况。物种多样性可通过计算物种丰富度指数、
							Shannon-Wiener指数、Simpson指数、Pielou均匀度指数和生态优势度指数等来综合研究。
							
							</p>
							<p>&nbsp;&nbsp;&nbsp;&nbsp;分析不同区域森林生态系统群落结构及生物多样性空间分异，揭示我国典型森林生态系统生物多样性空间分布变化，为生物多样性保护提供科学依据。</p>
                           <p>&nbsp;&nbsp;&nbsp;&nbsp; <b> 数据：</b>
                           	森林植物群落乔木层植物种组成（FA03）、森林植物群落灌木层植物种组成（FA04）、森林植物群落草本层植物种组成（FA05）
                       	  </p>
                           <p>&nbsp;&nbsp;&nbsp;&nbsp;<b>考核要求：</b>
						      <p>&nbsp;&nbsp;&nbsp;&nbsp;（1）研究意义：主要考察研究报告能否阐述研究的意义、国内外相关研究进展，满分15分；</p>
