...
<html>
	...
	<head>
		<title> 林业科学数据平台: 林业年度统计数据的可视化工具 </title>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title">林业年度统计数据的可视化工具 </span></a></p>
                
                
                <h2 class="h_title"> 林业年度统计数据的可视化工具 </h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						　　<p>&nbsp;&nbsp;&nbsp;&nbsp;<b> 要求：</b>
							编写软件，把林业年度统计数据的主要指标值由数表形式，
							展示为二维和/或三维图形和/或动画的形式。编写所用的程序语言不作限制。

              </p>
                           <p>&nbsp;&nbsp;&nbsp;&nbsp; <b> 数据：</b>
                   	      <p>&nbsp;&nbsp;&nbsp;&nbsp; 中国林业发展报告与林业年度统计数据库</p>
                           	    <p> &nbsp;&nbsp;&nbsp;&nbsp; 国家级森林资源统计数据库；</p>
                           	
                           	
                           	</p>
                           <p>&nbsp;&nbsp;&nbsp;&nbsp;<b>考核要求：</b>
						      <p>&nbsp;&nbsp;&nbsp;&nbsp;1、能够输入2维数表，准确地转换为饼图、直方图等2维和/或3维图形形式。【60分】</p>
							  <p>&nbsp;&nbsp;&nbsp;&nbsp;2、能够生成动画，根据动画的主题突出、动作流畅的程度，酌情加分。【0-20分】</p>
							  <p>&nbsp;&nbsp;&nbsp;&nbsp;3、根据可视化结果的醒目、生动、美观的程度，酌情加分。【0-20分】</p>
