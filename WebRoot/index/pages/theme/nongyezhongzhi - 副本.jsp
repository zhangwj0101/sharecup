					...
					<div class="m-detail">
						...
						　　<p>&nbsp;&nbsp;&nbsp;&nbsp;<b>要求：</b>
							     <p> 为计算种子千粒重或百粒重而进行数粒，是农作物种质资源鉴定评价的一项基本工作，但人工数粒比较费时且费力，而购置专门的数粒设备则需要花费大量经费。因此，通过拍摄种子图像，
							     	利用计算机软件对图像进行识别，自动计算出种子粒数，无疑是既简便又经济的方法之一。</p>
                           ...
                           <p>&nbsp;&nbsp;&nbsp;&nbsp;<b> 数据：</b>
                           	...
                           	平台提供的小麦、玉米、大麦、菜豆、豌豆、辣椒、茄子、苋菜、芥菜、南瓜、西瓜等农作物共18幅图像。如需更多农作物种子图像，请与国家农作物种质资源平台办公室联系，010-62156875，office@cgris.org。
                           	注：为展现农作物品种的多样性，某些图像混合了同类作物的不同品种资源。
