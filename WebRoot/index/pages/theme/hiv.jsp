...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title">抗HIV药物活性与结构的关系研究</span></a></p>
                
                
                <h2 class="h_title">抗HIV药物活性与结构的关系研究</h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						　　<p>&nbsp;&nbsp;&nbsp;&nbsp;<b>要求：</b>    通过活性数据库（抗HIV）检索，结合相关文献查阅，分析多种不同类型药物的活性与其特征结构的关系；讨论抗HIV药物的毒性与其结构的关联；为低毒、高效的抗HIV新药设计提出合理的设想。以论文形式表达。</p>
                           <p>&nbsp;&nbsp;&nbsp;&nbsp;<b>数据：</b>    1. 抗HIV药物活性数据库：http://www.appchem.csdb.cn/hivdata/hiv.jsp</p>
                           <p>&nbsp;&nbsp;&nbsp;&nbsp;<b>考核要求及分值</b></p>
							<p>&nbsp;&nbsp;&nbsp;&nbsp;1．通过相关文献的检索，总结抗HIV研究的进展，以及抗HIV的发展趋势。（20分）</p>
							<p>&nbsp;&nbsp;&nbsp;&nbsp;2．研究分析多种不同类型抗HIV药物的活性与其特征结构的关系。（30分）</p>
							<p>&nbsp;&nbsp;&nbsp;&nbsp;3．研究分析多种不同类型抗HIV药物的毒性与其特征结构的关系。（30分）</p>
							 <p>&nbsp;&nbsp;&nbsp;&nbsp;4．提出低毒、高效的抗HIV新药设计提出合理的设想，并给出理论依据。（20分）</p>
						</div>
