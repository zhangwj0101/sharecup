...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title"> 病原微生物安全知识科普宣传 </span></a></p>
                
                
                <h2 class="h_title"> 病原微生物安全知识科普宣传 </h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						   ...
						   <p><b>二、作品要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;结合您所了解的生物安全知识（安全事故、预防、检测等），要求能形象生动地对某类生物安全事故的预防或检测的工作流程（包括原理、操作步骤等）面向非专业人员或普通老百姓做一次科普宣传，参赛作品可采用Flash、动漫、视频、海报或PPT等多种形式，要求画面生动、图解扼要、浅显易懂、趣味性强、可加旁白或文字说明、形式不限、篇幅尽量简洁。</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;例如：Flash等可参考《侏罗纪公园1》中介绍从古代蚊虫体内提取恐龙DNA以及克隆出恐龙的电影片段。</span><br>
						   </p>							
						   
						   <p><b>三、提供资源：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp; 1. “中国应急分析网”中的“生物安全应急分析技术资源库”中与病原微生物有关的数据，网址：http://www.ceas.org.cn/shengw.html</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp; 2. 可利用网络资源等获取病原微生物安全相关的文献资料。</span><br>
						   </p>
						
						   <p><b>四、考核要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;能形象生动地呈现出某类（个）生物安全事故的预防或检测流程，能让一个专业性较强的知识被广大非专业人员或普通老百姓所接受或理解。按满分100分计。</span>
						   </p>						   						   					　　
						
						   <p><b>五、评审原则和标准：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;是否形象生动、是否能突出某一知识的关键环节、是否能利用较小的篇幅呈现一个相对完整的“故事”；形式不限；篇幅简洁。	</span>
						   </p>						   						   
						</div>
