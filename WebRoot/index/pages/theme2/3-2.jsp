...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title"> 中国甲虫高级阶元与常见种检索图 </span></a></p>
                
                
                <h2 class="h_title"> 中国甲虫高级阶元与常见种检索图 </h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						   ...
						   <p><b>二、作品要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;1. 操作简便、言简意赅；常见种典型特征的精选和规范记述；关键特征的遴选和鉴别特征图像的标准型。</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;2. 整体照片清晰，图像有代表性，有地理分布信息，照片有尺寸参照物，雌雄性别有显著差异时提供相关照片。</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;3. 照片数量和清晰度符合要求，介绍性描与照片相一致。</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;4. 软件的功能完整，操作简单，界面简洁友好，运行稳定，响应速度快行。</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;5. 内容原创。</span><br>
						   </p>							
						   
						   <p><b>三、提供资源：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;标本资源共享平台昆虫纲鞘翅目物种信息数据库</span><br>
						   </p>
						
						   <p><b>四、考核要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;1. 是否成功构建了操作简便、言简意赅的中国甲虫科级阶元与常见种检索图软件【20分】；软件的功能是否完整【5分】，操作是否简单【5分】，界面是否简洁友好【5分】，运行是否稳定【5分】，响应速度是否快速【5分】。</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;2. 中国甲虫高级阶元的分类特征选择是否准确【5分】，文字是否言简意赅【5分】，特征图选择与文字是否相对应【10分】。</span><br>					   							   							   							   	
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;3. 图像是否有代表性【5分】，是否有地理分布信息【2.5分】，照片中是否有尺寸参照物【2.5分】，雌雄性别有显著差异时是否提供相关照片【5分】。</span><br>					   							   							   							   	
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;4. 软件是否具有原创性【20分】。</span><br>					   							   							   							   	
						   </p>						   						   					　　
