...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title"> 人源细胞特性鉴定 </span></a></p>
                
                
                <h2 class="h_title"> 人源细胞特性鉴定 </h2>
					...
					<div class="m-detail">
						...
						<div class="m-content">
						   ...
						   <p>
						   	...
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;2、作品内容：通过查阅文献，设计实验，对细胞资源共享平台现保藏的人来源的一种或一类细胞进行特性（如肺、乳腺、血管内皮等）的鉴定；
						   	</span>
						   </p>							
						   ...
						   <p><b>四、考核要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;1）题目理解准确（10分）；</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;2）实验设计合理（20分）；</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;3）实验方法可行（20分）；</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;4）实验结果可靠（20分）；</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;5）报告清晰完整（20分）。</span>
						   	<br>
						   </p>	
						   
						   <p><b>五、联系方式：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;卞晓翠：bxiaocui415@163.com；010-69156473；13811805663</span>
						   </p>						   						   					　　
