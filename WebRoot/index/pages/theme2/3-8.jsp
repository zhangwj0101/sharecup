...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title"> 我国水产生物资源分布查询系统 </span></a></p>
                
                
                <h2 class="h_title"> 我国水产生物资源分布查询系统 </h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						   ...
						   <p><b>二、作品要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;开发一款小型软件，实现如下功能：1）根据地理位置（省份）来查询该地方的水产生物资源信息；2）根据水产生物资源名称查询其分布的地理位置（省份）。通过创新实现，增强参赛大学生的动手能力，并加强他们对我国水产生物资源的了解。</span><br>
						   </p>							
						   
						   <p><b>三、提供资源：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;水产生物资源地理分布数据.xlsx</span><br>
						   </p>
						
						   <p><b>四、考核要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;1、	功能完整（30分）</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;2、	运行稳定、界面友好、运行速度快（20分）</span><br>					   							   							   							   	
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;3、	GIS地图的应用（20分）</span><br>					   							   							   							   	
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;4、	数据库技术的运用（10分）</span><br>					   							   							   							   	
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;5、	基于移动终端系统（10分）</span><br>					   							   							   							   	
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;6、	提供操作说明文档（10分）	</span><br>					   							   							   							   	
						   </p>						   						   					　　
