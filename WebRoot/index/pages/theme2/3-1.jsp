...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title"> 地震震动仿真软件制作 </span></a></p>
                
                
                <h2 class="h_title"> 地震震动仿真软件制作 </h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						   ...
						   <p><b>二、作品要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;1、开发客户端软件，仿真地震波传播到本地（客户端所在地）的时间和地震动强度（或烈度）。</span><br>
						   </p>							
						   
						   <p><b>三、提供资源：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;1、2013年4月20日芦山主震地震目录和震相数据</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;2、台站基本参数</span><br>	
						   </p>
