...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title"> 微生物微观世界视频 </span></a></p>
                
                
                <h2 class="h_title"> 微生物微观世界视频 </h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						   ...
						   <p><b>二、作品要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;借鉴BBC制作的《生命》纪录片，选取代表性微生物物种,从显微镜下拍摄微生物微观形态,以及微生物生长、特征性状变化，结合菌株功能，制作具备科普与观赏一体的视频。 	</span><br>
						   </p>							
						   
						   <p><b>三、提供资源：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;由参赛者提出具体需求，具有典型特征酵母菌、细菌、放线菌、真菌等。</span><br>
						   </p>
