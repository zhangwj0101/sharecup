...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title"> 月季品种图像识别软件开发 </span></a></p>
                
                
                <h2 class="h_title"> 月季品种图像识别软件开发 </h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						   ...
						   <p><b>二、作品要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;开发一款工具软件，实现月季不同品种自动模糊识别功能。</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;利用图像相似性原理，通过建立标准图片库，将上传图片与数据库中图片进行比对识别出月季品种或相似品种。</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;考虑该工具软件的扩展功能，以便该软件可通过不断丰富标准图片数据库用于其它植物如牡丹、茶花等品种的图像鉴别。</span><br>
						   </p>							
						   
						   <p><b>三、提供资源：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;林木种质资源平台收集保存的月季品种约1000份，本次竞赛提供100张左右不同月季品种的标准图片作为标准品种数据库，参赛者也可通过其它途径收集图片扩大标准图片数据库。</span><br>
						   </p>
						
						   <p><b>四、考核要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp; 1. 是否能够实现对上传图片相似性的分析【40分】；</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp; 2. 是否能对月季品种进行较为准确的识别【20分】；</span><br>					   							   							   							   	
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp; 3. 是否构建了月季品种数据库对花色、花型等信息进行规范描述，是否能够扩展到其它植物品种（如牡丹等）的识别【20分】；</span><br>					   							   							   							   	
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp; 4. 软件的功能是否完整，操作是否简单，界面是否简洁友好，运行是否稳定，响应速度是否快【20分】；	</span><br>					   							   							   							   	
						   </p>						   						   					　　
