...
<html>
	...
	<head>
		<title> 特定领域国内外标准物质资源调查及对比分析研究 </title>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title"> 特定领域国内外标准物质资源调查及对比分析研究 </span></a></p>
                
                
                <h2 class="h_title"> 特定领域国内外标准物质资源调查及对比分析研究 </h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						   ...
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;
						   		针对地质等特定领域的国内外标准物质情况开展调查，形成分析对比数据，并对该领域我国标准物质发展提出建议，形成论文。
						   	</span>
						   </p>							
						   
						   <p><b>三、提供资源：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;1、	标准物质资源清单</span>	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;2、	国外资源网站</span>	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 国际标准物质数据库 www.comar.bam.de/en/</span>	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 美国标准化与技术研究院 www.nist.gor.cn</span>	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 英国政府化学家实验室 www.lgc.co.uk</span>	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 欧盟标准物质研究中心 www.irmm.jrc.ec.europa.eu/	</span>	<br>
						   </p>
						
						   <p><b>四、考核要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;1.该领域国内资源获批情况分析（10分）</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;2. 该领域国内资源实物存量情况分析（20分）</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;3.该领域标准物质资源需求现状分析（20分）</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;4.国际该领域资源现状分析（20分）</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;5.国内外资源对比分析（15分）</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;6.存在的问题及建议（15分）</span>						   							   							   							   	
						   </p>						   						   					　　
