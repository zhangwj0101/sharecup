...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title"> 地学数据标注、引用与出版报告 </span></a></p>
                
                
                <h2 class="h_title"> 地学数据标注、引用与出版报告 </h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						   ...
						   <p><b>二、作品要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;提出科学数据标注、引用与出版的研究报告。主要内容包括：</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;（1）分析当前科学数据共享存在的问题；</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;（2）针对问题提出地学数据在标注、引用与出版等方面的解决方案及关键技术问题；</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;（3）以地球系统科学数据共享提供的配套资源，进行应用实践，指出示范效果。</span><br>
						   </p>							
						   
						   <p><b>三、提供资源：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;寒区旱区科学数据中心数据施引文献库：http://westdc.westgis.ac.cn/knowledge/user;</span><br>
						   </p>
						
						   <p><b>四、考核要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;（1）	研究报告创新性，30分</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;（2）	研究报告实用性，30分</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;（3）	问题分析把握程度，25分</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;（4）	报告结构严谨、论述清晰，10分</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;（5）	写作流畅，5分	</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;</span>						   							   							   							   	
