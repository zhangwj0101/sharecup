...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title"> 标准与生活 </span></a></p>
                
                
                <h2 class="h_title"> 标准与生活 </h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						   ...
						   <p><b>二、作品要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;1.作品以动画或者视频形式呈现，作品时长：5-10分钟；</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;2.作品选取与自己生活密切相关的产品或热点话题（例如：饮用水、口罩、电动汽车等等）说明产品的标准对人民生活的重要影响。</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;3.可根据自己的创意添加音乐或解说词；</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;4.声音清晰，画面稳定；</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;5.参赛作品必须是原创作品，禁止抄袭、拼接。</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;备注：作者可在确保作品内容健康向上的前提下，可以不拘一格，自由发挥自己的创意。</span><br>
						   </p>							
						   
						   <p><b>三、提供资源：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;1.饮用水国家标准</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;2.电动汽车国家标准标准</span><br>
						   </p>
