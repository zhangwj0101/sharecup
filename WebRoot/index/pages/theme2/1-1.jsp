...
<html>
	...
	<head>
		<title> 基于红外相机调查数据的XX保护区保护现状分析与保护对策研究区 </title>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
                ...
                <h2 class="h_title"> 基于红外相机调查数据的XX保护区保护现状分析与保护对策研究区 </h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						   ...
						   <p><b>二、作品要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;针对某一保护区2-3年的野外红外相机监测，通过查阅参考文献结合所得数据分析，研究该保护区的野生动物物种现状，并提出合理的保护建议。本竞赛提供2个保护区的红外相机数据，参赛团队根据其专业领域选择一个保护区进行研究，并提交研究报告。数据：神农架国家级自然保护区野生动物红外相机数据；新疆罗布泊野骆驼国家级自然保护区野生动物红外相机数据。</span>
						   </p>							
						   ...
						   <p><b>四、考核要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;1. 论文的撰写应在较全面掌握现有相关研究文献的基础上并结合所得数据进行 满分10分；</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;2. 使用的数据分析方法可靠 满分30分；</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;3. 能够获得一般性的结论 满分20分；  </span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;4. 写作规范，标题、内容提要、关键词、正文、语言、注释和都参考，文献都比较规范 满分20分；</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;5. 综合评分根据论文观点、创新点、现实意义及工作量等 满分20分。</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;</span>						   							   							   							   	
						   </p>						   						   					　　
