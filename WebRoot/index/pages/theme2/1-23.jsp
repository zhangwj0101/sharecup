...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title"> 野生鸟类数量与环境变化关系研究 </span></a></p>
                
                
                <h2 class="h_title"> 野生鸟类数量与环境变化关系研究 </h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						   ...
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;
						   	基于野生动物及其所处环境，自行查阅相关文献资料，结合平台提供的野生动物监测数据，开展针对野生鸟类数量变化及其所处环境的研究，并提供研究报告或论文。论文题目可依据选取的环境对象不同等进行适当变更。
						   	</span>
						   </p>							
						   ...
						   <p><b>四、考核要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;1、论文的撰写是在查阅分析相关文献基础上并结合数据得到【20分】。</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;2、使用的数据分析方法可靠【30分】。</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;3、论文的撰写规范，图标清晰【15分】。 </span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;4、观点明确，结论合理，并结合工作量与现实意义等，综合评分【35】。</span>
						   </p>	
						   					   						   					　　
						   <p><b>五、其他说明：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;论文或报告必须是原创性结果，若选用了本平台数据请予以说明。在环境因子选取中，可自行酌情选取土壤、方位等若干因子。</span>
						   </p>					   						   					　　
