...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title"> 开放信息资源的发现与利用 </span></a></p>
                
                
                <h2 class="h_title"> 开放信息资源的发现与利用 </h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						   ...
						   <p><b>三、提供资源：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;提供中英文摘要、关键词和参考文献	网址：www.nstl.gov.cn
						   	</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;可免费检索，如需原文或者大量的数据，请与联系人联系。
						   	</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;刘华/58882061
						   	</span><br>	
						   </p>
