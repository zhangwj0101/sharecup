...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title"> 古树名木生长状况与环境因子关系研究 </span></a></p>
                
                
                <h2 class="h_title"> 古树名木生长状况与环境因子关系研究 </h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						   ...
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;
						   	基于古树名木调查及其所处环境的数据，请自行查阅相关文献资料，结合平台提供的浙江省部分古树名木数据，开展针对古树名木生长及其与环境关系的研究，并提供研究报告或论文。论文题目可依据选取的若干环境因子等进行适当变更。
						   	</span>
						   </p>							
