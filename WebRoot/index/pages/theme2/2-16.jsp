...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title"> 植物生长过程动漫演示 </span></a></p>
                
                
                <h2 class="h_title"> 植物生长过程动漫演示 </h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						   ...
						   <p><b>二、作品要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;制作针叶树种、阔叶树种等不同类型树种的种子发芽、生长、光合作用、开花、结实等各个环节的动漫或PPT作为科普宣传的材料。参赛者通过种子发芽试验、绘制示意图、搜集相关图片资料等进行综合制作。</span><br>
						   </p>							
						   
						   <p><b>三、提供资源：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;平台可提供所需的种子，参赛者可以平台联系获取实物资源。林富荣/62889633</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;参赛者也可通过自己网上查找相关科普资源完成</span><br>
						   </p>
						
						   <p><b>四、考核要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;1.	提交的作品必须为原创性作品，主题及内容要与竞赛题目要求相关。【30分】</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;2.	是否能够展现不同类型植物、不同生长过程的差异【40分】</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;3.	完成的作品要界面友好、能容丰富、展示生动，充分体现大学生的活力和创新思想。【30分】	 </span>
						   	<br>
						   </p>						   						   					　　
