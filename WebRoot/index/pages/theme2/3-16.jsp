...
<html>
	...
	<head>
		<title> 种质资源地理分布信息系统查询与展示网页设计 </title>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title"> 种质资源地理分布信息系统查询与展示网页设计 </span></a></p>
                
                
                <h2 class="h_title"> 种质资源地理分布信息系统查询与展示网页设计 </h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						   ...
						   <p><b>二、作品要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;依托google earth或者专业地理信息系统软件，开发出林木种质资源地理分布展示网页，实现与网站数据的整合，将种质资源查询的结果在网页上展现出其地理分布的情况，包括原产地分布情况以及保存地分布情况等。</span><br>
						   </p>							
						   
						   <p><b>三、提供资源：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;提供具有地理信息1个保存库及杉木、马尾松2个树种的3000余份种质资源数据作为示例数据。</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;1. 杉木种质资源数据1402条记录</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;2. 马尾松种质资源1516条记录</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;3. 林科院热林中心(大青山库)种质资源数据1213条记录</span><br>
						   </p>
						
						   <p><b>四、考核要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;1.	将资源查询与地理分布展示结合[40分]</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;2.	具有统计和关联功能[40分]</span><br>					   							   							   							   	
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;3.	展示界面友好、浏览速度快，方便切换[20分]	</span><br>					   							   							   							   	
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;</span><br>					   							   							   							   	
						   </p>						   						   					　　
