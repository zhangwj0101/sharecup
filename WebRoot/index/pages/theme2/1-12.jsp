...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title"> 微生物应用功能评价研究 </span></a></p>
                
                
                <h2 class="h_title"> 微生物应用功能评价研究 </h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						   ...
						   <p><b>二、作品要求：</b></p>
						   <p>
<span>&nbsp;&nbsp;&nbsp;&nbsp;参赛者任选其中一个主题参赛:</span><br>						   	
<span>&nbsp;&nbsp;&nbsp;&nbsp;1、微生物发酵产物功能特性、特征研究。	</span><br>
<span>&nbsp;&nbsp;&nbsp;&nbsp;2、对植物、动物有益微生物的分离、筛选评价与鉴定。	</span><br>
<span>&nbsp;&nbsp;&nbsp;&nbsp;3、生物质转化功能微生物菌株的筛选与功能评价。	</span><br>
						   </p>							
						   
						   <p><b>三、提供资源：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;
						   	由参赛者提出具体需求，国家微生物资源平台依据资质，有实验能力，符合生物安全需求，提供资源。
						   	</span>
						   </p>
						   ...
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;
						   	刘小飞&nbsp;&nbsp;010-82108651-630&nbsp;&nbsp;13911858910&nbsp;&nbsp;xfliu@caas.ac.cn
						   	</span>
						   </p>
