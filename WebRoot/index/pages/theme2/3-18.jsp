...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title"> 基于移动终端的林业信息查询系统 </span></a></p>
                
                
                <h2 class="h_title"> 基于移动终端的林业信息查询系统 </h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						   ...
						   <p><b>二、作品要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;制作一个基于Windows Phone或其它系统的移动客户终端软件,实现对于本平台主页上的林业发展数据的查询。在移动设备上可以查询林业科学数据平台主页上的林业发展数据，以数字表格、柱状图、电子地图等形式展示查询结果。编写语言不做限制。</span><br>
						   </p>							
						   
						   <p><b>三、提供资源：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;2010-2012年林业发展报告</span><br>
						   </p>
						
						   <p><b>四、考核要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;1.能够实现对于本平台主页上的林业发展数据的查询; 以数字表格、柱状图、电子地图等形式展示查询结果；实现数据资源的统计分析功能，以柱状图等形式呈现统计结果;可以在Windows phone或其它系统的移动设备上安装使用与操作，【0-60分】</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;2.能够实现更多功能，酌情加分【0-20分】</span><br>					   							   							   							   	
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;3.界面美观，交互友好，酌情加分【0-20分】</span><br>					   							   							   							   	
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;</span><br>					   							   							   							   	
						   </p>						   						   					　　
