...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title"> 新疆饲用植物展示工具 </span></a></p>
                
                
                <h2 class="h_title"> 新疆饲用植物展示工具 </h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						   ...
						   <p><b>二、作品要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;基于配套资源的相关数据，设计一个BS结构的软件工具，以配套资源所提供的数据为基础，以图文并茂的方式展示新疆饲用植物各项属性，软件必须具有针对“建种群”、“亚种群”等要素的检索功能。</span><br>
						   </p>							
						   
						   <p><b>三、提供资源：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;新疆主要饲用植物数据库及其配套图像文件</span><br>
						   </p>
						
						   <p><b>四、考核要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;1实现在线的形式展示数据，具备多种方式查询、浏览和导出功能，可以支持IE、Googlechrome、Firefox等浏览器显示。【0-60分】。</span><br>
