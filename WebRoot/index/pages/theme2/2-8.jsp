...
<html>
	...
	<head>
		<title> 国家农作物种质资源平台标识Logo设计 </title>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title"> 国家农作物种质资源平台标识Logo设计 </span></a></p>
                
                
                <h2 class="h_title"> 国家农作物种质资源平台标识Logo设计 </h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						   ...
						   <p><b>二、作品要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;反映农作物种质资源特色，体现平台的特点。</span><br>
						   </p>							
						   
						   <p><b>三、配套的资源名称或列表：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;平台介绍材料，国家农作物种质资源平台_基本情况.ppt。</span><br>
						   </p>
