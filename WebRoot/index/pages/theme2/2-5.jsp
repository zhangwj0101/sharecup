...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title"> 扫描电子显微镜工作原理动画制作 </span></a></p>
                
                
                <h2 class="h_title"> 扫描电子显微镜工作原理动画制作 </h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						   ...
						   <p><b>二、作品要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;扫描电子显微镜利用电子束扫描样品表面从而获得样品的信息。广泛应用于材料、物理、化学、生物、地学等相关研究。</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;本题目要求以动画的形式生动展现扫描电子显微镜的工作原理（包括但不限于电子与物质相互作用、扫描电子显微镜的工作原理及结构、二次电子、背散射电子、特征x射线的产生及其影响因素等），开发工具及程序语言不作限制。所有参赛作品须以精炼、准确的科学术语阐述仪器每部分工作原理，同时提供电子版本的作品简介。具体的扫描电子显微镜型号不限，可以自行联系。</span><br>
						   </p>							
						   
						   <p><b>三、推荐参考书籍：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;1. 章晓中. 电子显微分析（材料科学与工程系列）. 清华大学出版社，2006.</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;2. J.I.戈尔茨坦. 扫描电子显微技术与X射线显微分析. 科学出版社，1988.</span><br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;3. David B. Williams, C. Barry Carter. Transmission Electron Microscopy A Textbook for Materials Science. Springer US, 2009.</span><br>
						   </p>
						
						   <p><b>四、考核要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;具体评分根据参赛者返回的动画作品质量以及可视化效果确定。作品要求全面准确地展现扫描电子显微镜的工作原理，构思新颖，内容及表现形式有创新。</span>
						   	<br>
						   </p>						   						   					　　
