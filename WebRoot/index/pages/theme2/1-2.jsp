...
<html>
	...
	<body>
		...
		<div id="box">
            ...
            <div class="right">
            	<p class="weizhi">您现在的位置：<a href="<%=basePath %>index/pageIndex.action">首页</a>&gt;&gt;<a href="<%=basePath %>index/pageIndex_theme.action">竞赛主题</a>&gt;&gt;<a href=""><span class="h_title"> 中国淡水蚌类濒危状况评估和保护对策 </span></a></p>
                
                
                <h2 class="h_title"> 中国淡水蚌类濒危状况评估和保护对策 </h2>
                ...
                <div class="p_cont">
					...
					<div class="m-detail">
						...
						<div class="m-content">
						   ...
						   <p><b>二、作品要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;1. 提供长江中下游地区完整蚌类物种分布；</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;2. 提供的优先保护物种的科学性强，依据数据库充分、完整；</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;3. 具有原创性。</span>
						   	<br>						   							   	
						   </p>							
						   ...
						   <p><b>四、考核要求：</b></p>
						   <p>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;１．是否成功构建了详细的中国长江中下游地区完整的淡水蚌类数据库【10分】，是否提供长江中下游地区完整的淡水蚌类物种分布及物种鉴别图谱和描述【10分】。</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;2.是否建立一个科学有效的蚌类濒危评估标准，其中评估指标制定的合理性【10分】，濒危等级划分的科学性【10分】，濒危评估效果与实际的相符性【15分】。</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;3. 提供的优先保护物种是否具有较强的科学性【10分】，是否提出切实可行的保护对策【15分】。</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;4. 内容是否具有原创性。【20分】</span>
						   	<br>
						   	<span>&nbsp;&nbsp;&nbsp;&nbsp;</span>						   							   							   							   	
						   </p>						   						   					　　
